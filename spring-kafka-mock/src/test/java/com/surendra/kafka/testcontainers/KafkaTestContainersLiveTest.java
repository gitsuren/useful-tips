package com.surendra.kafka.testcontainers;
...
import com.surendra.kafka.embedded.KafkaConsumer;
import com.surendra.kafka.embedded.KafkaProducer;
import com.surendra.kafka.embedded.KafkaProducerConsumerApplication;
...
@Import(com.surendra.kafka.testcontainers.KafkaTestContainersLiveTest.KafkaTestContainersConfiguration.class)
...
public class KafkaTestContainersLiveTest {
    ...
    public void givenKafkaDockerContainer_whenSendingtoDefaultTemplate_thenMessageReceived() throws Exception {
        ...
        assertThat(consumer.getPayload(), containsString("Sending with default template"));
    }
    ...
    public void givenKafkaDockerContainer_whenSendingtoSimpleProducer_thenMessageReceived() throws Exception {
        ...
        assertThat(consumer.getLatch().getCount(), equalTo(0L));
        assertThat(consumer.getPayload(), containsString("embedded-test-topic"));
        assertThat(consumer.getPayload(), containsString("Sending with own controller"));
    }
    ...
    static class KafkaTestContainersConfiguration {
        ...
        public Map<String, Object> consumerConfigs() {
            ...
            props.put(ConsumerConfig.GROUP_ID_CONFIG, "surendra");
